...
const Page = (props: Props) => {
    ...
    return (
        <div className={`overflow-hidden ${isModalOpen ? 'h-screen' : ''}`} style={{ scrollSnapType: 'y mandatory' }}>
            <Introducing />
            <section>
                <PurpleSection />
            </section>
            ...
            <section>
                <ViewOfAMordernLauge lenis={lenisInstance} setIsModalOpen={setIsModalOpen} />
            </section>
            <section>
                <CarouselCarpenters />
            </section>

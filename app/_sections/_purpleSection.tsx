...
const PurpleSection = (props: Props) => {
        ...
        gsap.utils.toArray('.purple-items').forEach((item: any) => {
            gsap.from(item, {
                scrollTrigger: {
                    ...
                    start: "top 80%",
                    onEnter: () => { //VER SE A GENTE TROCA ESSE ROLE POR UM HOVER PARA FICAR MAIS INTERATIVO
    ...
    return (
        <div
            style={{ background: "linear-gradient(90deg, rgba(42,38,106,1) 0%, rgba(67,62,153,1) 50%, rgba(42,38,106,1) 100%)", scrollSnapAlign: 'start'}}
            className=''
        >

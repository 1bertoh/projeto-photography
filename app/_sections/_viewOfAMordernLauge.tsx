    ...
    return (
        <>
            <div
                ...
                style={{ background: `url(${bg.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover' }}
            ...
            <div className='bg-white py-32'>
                ...
                Virtual photography offers cost-effective, eco-friendly solutions for showcasing products with precision and creativity.
                </p>
            </div>
            <div className='bg-white py-32'>
    ...
    return (
        ...
        >
            ...
            <div className=' relative'>
                <div
                    className='p-2 bg-red-500 rounded-full z-20 relative right-0 top-0'
                >
                    <Expand size={11} />
                </div>
                <div id='pulse-expand' className='p-2 bg-red-500 rounded-full right-0 absolute  opacity-100 z-10 top-0 h-full w-full
    '       >
                </div>
            </div>
        </div>
    ...
    return (
        <div>
            ...
            <div className='bg-white '>
                ...
                High-quality virtual photography ensures realistic, detailed visuals that elevate brand credibility and customer trust. 
                </h2>
                <div className='px-3 pb-5'>
                    <div className='flex gap-3'>
                        <div
                            ...
                            ></div>
                        <div 
                            style={{ background: `url(${image2.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover'}}
                            className='w-7/12 h-[32rem] rounded-lg bg-slate-700'
                        ></div>
                    </div>
                    <div className='flex mt-3 gap-3'>
                        <div
                            style={{ background: `url(${image3.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover'}}
                            className='w-7/12 h-[32rem] rounded-lg bg-slate-600'
                            ></div>
                        <div 
                            style={{ background: `url(${image4.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover'}}
                            className='w-5/12 h-[32rem] rounded-lg bg-slate-700'
                        ></div>
                    </div>
                    <div className='flex mt-3 gap-3'>
                        <div
                            style={{ background: `url(${image5.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover'}}
                            className='w-full h-[32rem] rounded-lg bg-slate-600'
                            ></div>
                    </div>
                    <div className='flex mt-3 gap-3'>
                        <div
                            style={{ background: `url(${image6.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover'}}
                            className='w-5/12 h-[32rem] rounded-lg bg-slate-600'
                            ></div>
                        <div
                            style={{ background: `url(${image7.src})`, backgroundPositionX: 'center', backgroundPositionY: 'center', backgroundSize: 'cover'}}
                            className='w-7/12 h-[32rem] rounded-lg bg-slate-600'
                            ></div>
                    </div>
                    <div className='flex mt-3 gap-3'>
